	...
	<div id="content">
		...
		<div id="modal">
			<div id="modal-inner" class="show">
				...
				<p id="modal-text2">Äá»«ng lo láº¯ng, báº¡n cÃ³ th Äáº·t láº¡i
					dá» dÃ ng</p>
				<p id="modal-text3">ChÃºng tÃ´i sáº½ gá»­i cho báº¡n má»t email
					cÃ³ liÃªn káº¿t Äá» Äáº·t láº¡i máº­t kháº©u cá»§a báº¡n.</p>
				<div class="login-box" id="email-container-modal">
					...
					<div id="get-pass-by-mail">
						<button type="submit">Gá»­i email Äáº·t láº¡i máº­t
							kháº©u</button>
					</div>
		...
		<div id="login">
				...
				<div class="login-method" id="gmail-method">
					<button id="gmail-button" type="sumit">
						<span class="button-wrapper"> <img class="gmail-icon"
							src="images/gmail.jpg"> ÄÄng nháº­p báº±ng Gmail
						</span>
			...
			<div class="register-container">
				...
				<a href="view/web/register.jsp">Đăng ký</a>
			</div>
		</div>
	</div>
