...
<body>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav  mx-auto ">
							...
							<li class="nav-item"><a class="nav-link"
								href="${pageContext.request.contextPath}/view/web/shop-grid.jsp">Thực
									đơn</a></li>
							<li class="nav-item"><a class="nav-link"
				...
				<div class="row">
					<div class="col-md-6  ">
						<div class="box ">
							<div class="img-box">
								<img
									src="${pageContext.request.contextPath}/view/web/images/o1.jpg"
									alt="">
							</div>
							<div class="detail-box">
	...
	<section class="food_section layout_padding-bottom">
		<div class="container">
					...
					<div class="col-sm-6 col-lg-4 all pizza">
						<div class="box">
							<div>
								<div class="img-box">
									<img
										src="${pageContext.request.contextPath}/view/web/img/product/2-miếng-gà-giòn+khoai-tây+pepsi.jpg"
										alt="">
								</div>
								<div class="detail-box">
									<h5>2 miếng gà giòn + khoai tây + nước ngọt</h5>
									<div class="options">
										<h6>20000đ</h6>
					...
					<div class="col-sm-6 col-lg-4 all burger">
						<div class="box">
							<div>
								<div class="img-box">
									<img
										src="${pageContext.request.contextPath}/view/web/img/product/1-miếng-gà-sốt-cay+cơm+nước ngọt.jpg"
										alt="">
								</div>
								<div class="detail-box">
									<h5>1 miếng gà sốt cay + cơm + nước ngọt</h5>
									<div class="options">
										<h6>50000đ</h6>
										<a href=""> <svg version="1.1" id="Capa_1"
												xmlns="http://www.w3.org/2000/svg"
					...
					<div class="col-sm-6 col-lg-4 all pasta">
						<div class="box">
							<div>
								<div class="img-box">
									<img
										src="${pageContext.request.contextPath}/view/web/images/f4.png"
										alt="">
								</div>
								<div class="detail-box">
									<h5>Nui chay</h5>
					...
					<div class="col-sm-6 col-lg-4 all fries">
						<div class="box">
							<div>
								<div class="img-box">
									<img
										src="${pageContext.request.contextPath}/view/web/images/f5.png"
										alt="">
								</div>
								<div class="detail-box">
					...
					<div class="col-sm-6 col-lg-4 all pizza">
						<div class="box">
							<div>
								<div class="img-box">
									<img
										src="${pageContext.request.contextPath}/view/web/images/f6.png"
										alt="">
								</div>
								<div class="detail-box">
									<h5>Pizza truyền thống</h5>
									<!--                  <p>-->
									<!--                    Veniam debitis quaerat officiis quasi cupiditate quo, quisquam velit, magnam voluptatem repellendus sed eaque-->
									<!--                  </p>-->
									<div class="options">
					...
					<div class="col-sm-6 col-lg-4 all burger">
						<div class="box">
							<div>
								<div class="img-box">
									<img
										src="${pageContext.request.contextPath}/view/web/images/f7.png"
										alt="">
								</div>
								<div class="detail-box">
									<h5>Burger kiểu Mỹ</h5>
									<!--                  <p>-->
									<!--                    Veniam debitis quaerat officiis quasi cupiditate quo, quisquam velit, magnam voluptatem repellendus sed eaque-->
									<!--                  </p>-->
									<div class="options">
			...
			<div class="btn-box">
				<a href="shop-grid.jsp"> Xem thêm </a>
			</div>
		</div>
	</section>
